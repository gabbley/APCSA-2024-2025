...
public class MovingSprite2 extends JPanel implements KeyListener {
    ...
    public MovingSprite2() {
        ...
        Timer timer = new Timer(3000, new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                changeRandomPosition(); // Call the method to change the sprite's position
            }
        });
    ...
    // Method to change the sprite's position to a random location
    private void changeRandomPosition() {
        x = (int) (Math.random() * (getWidth() - SPRITE_SIZE));  // Random X position
        y = (int) (Math.random() * (getHeight() - SPRITE_SIZE)); // Random Y position
        repaint(); // Redraw the sprite at the new location
    }
